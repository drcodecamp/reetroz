...
Usage:
  python scripts/download_cgw.py
  python scripts/download_cgw.py --from-year 2000 --to-year 2006
  python scripts/download_cgw.py --catalog-only
"""
...
from library_paths import PDF_ROOT
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=str(PDF_ROOT / "CGW"),
        help="Destination folder (default: H:/cat-library/CGW)",
    )
